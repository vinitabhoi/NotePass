...
<div class="card-btn">
	<div class="abtn text-center ">
	<a href="generate.jsp"><button type="button" class="buto btn-warning btn-lg mt-5">Generate and Store</button></a>
	</div>
	
	<div class="text-center">
	<a href="showpassword.jsp"><button type="button" class="buto btn-info btn-lg mt-5">Show Passwords</button></a>
	</div>
</div>
